...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			method = MainActivity.class.getDeclaredMethod("getString2",
					String[].class);
			HookUtils.hookMethod(method,
					"([Ljava/lang/String;)Ljava/lang/String;",teskhookcallback);
		} catch (NoSuchMethodException e) {
			e.printStackTrace();
		}
		...
		try {
			method = MainActivity.class.getDeclaredMethod("getString3",
					int.class, String.class);
			HookUtils.hookMethod(method,
					"(ILjava/lang/String;)Ljava/lang/String;",teskhookcallback);
		} catch (NoSuchMethodException e) {
			e.printStackTrace();
		}
		...
		try {
			method = MainActivity.class.getDeclaredMethod("getString4",
					int.class, String.class);
			HookUtils.hookMethod(method,
					"(ILjava/lang/String;)Ljava/lang/String;",teskhookcallback);
		} catch (NoSuchMethodException e) {
		...
		Log.i("TTT", "before5: ");
		try {
			method = MainActivity.class.getDeclaredMethod("getString5",
					Method.class);
			HookUtils.hookMethod(method,
					"(Ljava/lang/reflect/Method;)Ljava/lang/String;",teskhookcallback);
